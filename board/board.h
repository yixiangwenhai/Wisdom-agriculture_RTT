...
#define BSP_I2C2_SCL_PIN       GET_PIN(B,12)
#define BSP_I2C2_SDA_PIN       GET_PIN(B,13)
#endif

#define BSP_USING_I2C4
#ifdef BSP_USING_I2C4
#define BSP_I2C4_SCL_PIN       GET_PIN(H,9)
#define BSP_I2C4_SDA_PIN       GET_PIN(H,7)
#endif

#define BSP_USING_I2C3

#ifdef BSP_USING_I2C3
#define BSP_I2C3_SCL_PIN       GET_PIN(B,0)
#define BSP_I2C3_SDA_PIN       GET_PIN(B,1)
#endif
